// Add Shopify action button to Sales Order list view
frappe.listview_settings['Sales Order'] = {
	add_fields: ['docstatus'],
	get_indicator: function(doc) {
		// Optional: customize list item indicators
		// return [__('Synced'), 'green'] for example
	},
	onload: function(listview) {
		listview.page.add_menu_item(__('Import Shopify Customers'), function() {
			const d = new frappe.ui.Dialog({
				...
				primary_action(values) {
					...
					frappe.call({
						method: 'ecommerce_integrations.controllers.shopify_sync.sync_customers_from_excel',
